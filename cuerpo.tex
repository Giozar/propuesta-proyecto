...
\begin{longtable}{m{.05\paperwidth} *{2}{m{.33\paperwidth}} @{}}
	...
	\end{itemize} &
	\begin{itemize}
	  \item El proyecto de Vargas empleó herramientas formales como FODA y KPIs; en \hl{el proyecto propuesto} se realizó un diagnóstico documentado a partir de observaciones y reuniones internas, sin metodologías académicas específicas.
	  \item No se contempla desarrollo tecnológico; \hl{el sistema propuesto} incluye una plataforma funcional con backend, frontend y despliegue en la nube.
	  \item Su enfoque es contable y administrativo; \hl{en este sistema propuesto} abarca trazabilidad digital, soporte técnico, automatización y arquitectura multitenant.
	\end{itemize} \\	
\midrule
...
\end{itemize} &
\begin{itemize}
  \item El proyecto de Muñoz no desarrolló un sistema digital; \hl{el proyecto propuesto} implementa una plataforma completa usando NestJS, React y MongoDB.
  \item Su enfoque es documental y administrativo; \hl{el sistema propuesto} automatiza procesos, permite trazabilidad digital y comunicación en tiempo real.
  \item \hl{La solución propuesta} está desplegada en la nube y diseñada para escalar bajo una arquitectura modular y multitenant.
\end{itemize} \\
...
\end{itemize} &
\begin{itemize}
  \item La tesis propone una solución conceptual y documental; \hl{el proyecto propuesto} desarrolla una plataforma funcional con tecnologías como NestJS, React y MongoDB.
  \item \hl{El sistema propuesto} integra comunicación en tiempo real, automatización de tareas, y está desplegado en la nube con arquitectura escalable.
...
\end{itemize} &
\begin{itemize}
  \item La tesis emplea un enfoque cualitativo tradicional; \hl{el proyecto propuesto} desarrolla una solución digital funcional e implementada.
  \item \hl{El sistema propuesto} utiliza tecnologías modernas como NestJS, React y MongoDB, integrando automatización y trazabilidad.
...
\end{itemize} &
\begin{itemize}
  \item Mientras Delgado analiza causas de fracaso en ERPs, \hl{el proyecto propuesto} desarrolla una solución funcional con NestJS, React y MongoDB.
  \item Su enfoque es teórico y diagnóstico; \hl{el sistema propuesto} es aplicado, con un sistema en funcionamiento dentro de una empresa real.
  \item \hl{La solución propuesta} automatiza procesos, incluye trazabilidad y comunicación digital, mientras que Delgado se enfoca en recomendaciones preventivas.
\end{itemize} \\
...
\end{itemize} &
\begin{itemize}
  \item El proyecto de Kopec se enfoca en planeación estratégica con herramientas como FODA y Canvas; en \hl{el proyecto propuesto}, la estructuración fue funcional, basada en necesidades detectadas internamente.
  \item Kopec no implementa soluciones tecnológicas; \hl{la propuesta de Airon Tools} incluye un sistema completo con backend, frontend y base de datos en la nube.
  \item \hl{el sistema propuesto} incorpora automatización, comunicación en tiempo real, soporte multitenant e infraestructura DevOps, elementos no abordados en el trabajo de Patiño.
\end{itemize} \\
\bottomrule
\end{longtable}
